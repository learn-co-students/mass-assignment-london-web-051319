# If you write a describe block without quotes like this, you need to define the described class (or method) for the tests to even run. It's sort of a freebie test to make sure you've actually defined the models you plan on
# testing.
